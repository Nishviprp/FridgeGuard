...
import { Save, Bell, BellOff, Volume2, VolumeX, DollarSign, LogOut } from 'lucide-react'
  ...
  return (
    <div className="max-w-xl mx-auto flex flex-col gap-6">
      ...
      <div className="card p-5 flex items-center justify-between">
        ...
        <button onClick={handleSignOut} className="btn-ghost text-sm" style={{ color: 'var(--red)' }}>
      ...
      <div className="card p-5 flex flex-col gap-4">
        ...
        <div>
          <label className="form-label">Daily digest time (UTC)</label>
      ...
      <div className="card p-5 flex flex-col gap-4">
        ...
        <div className="flex items-center justify-between">
          <div>
            <p className="font-medium text-sm" style={{ color: 'var(--text)' }}>Browser Push Notifications</p>
            <p className="text-xs" style={{ color: 'var(--muted)' }}>Get alerts even when app is in background</p>
          </div>
          {form.push_enabled === 'true' ? (
            <button onClick={disableNotifications} className="btn-ghost text-sm">
        ...
        <div className="flex items-center justify-between">
          ...
          <button onClick={() => toggle('sound_enabled')} className="btn-ghost" style={{ padding: '8px' }}>
      ...
      <div className="card p-5 flex flex-col gap-4">
        ...
        <div>
          ...
          <div className="relative">
            <DollarSign size={15} className="absolute left-3 top-1/2 -translate-y-1/2" style={{ color: 'var(--muted)' }} />
            <input
